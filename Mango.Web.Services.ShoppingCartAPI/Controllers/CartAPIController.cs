...
using Mango.Web.Services.ShoppingCartAPI.Models;
using Mango.Web.Services.ShoppingCartAPI.Models.Dto;
using Mango.Web.Services.ShoppingCartAPI.RabbitMQSender;
using Mango.Web.Services.ShoppingCartAPI.Service.IService;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace Mango.Web.Services.ShoppingCartAPI.Controllers
{
    [Route("api/cart")]
    [ApiController]
    public class CartAPIController : ControllerBase
    {
        private CartResponseDto _response;
        ...
        {
            _db = db;
            this._response = new CartResponseDto();
            _mapper = mapper;
        ...
        [HttpPost("CartUpsert")]
        public async Task<CartResponseDto> CartUpsert(CartDto cartDto)
        {
            try
            {
        ...
        [HttpPost("RemoveCart")]
        public async Task<CartResponseDto> RemoveCart([FromBody]int cartDetailsId)
        {
            try
            {
